    ...
    encounters: [
        {
            ...
            order: 0,
            fights: [
                mockFight('tob-maiden', 'The Maiden of Sugadinti', 0, {fightDurationTicks: 9500, groupId: 'tob-1'}),
                mockFight('tob-bloat', 'Pestilent Bloat', 1, {fightDurationTicks: 6200, groupId: 'tob-1'}),
                mockFight('tob-nylo', 'Nylocas Vasilias', 2, {fightDurationTicks: 8800, groupId: 'tob-1'}),
            ],
        },
        {
            type: 'fight' as const,
