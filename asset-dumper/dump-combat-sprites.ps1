param(
    ...
    [string]$Output = "../src/assets/combat"
)
...
Write-Host "Dumping combat sprites from $CacheDir ..."
java -cp $Jar org.runelogs.assetdumper.CombatSpriteDumper --cache $CacheDir --output $Output
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
