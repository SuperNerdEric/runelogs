...
export function isCrownAvatar(
  avatarId: AvatarId,
): avatarId is typeof CROWN_AVATAR_ID {
...
export function isLockedAvatar(
  avatarId: AvatarId,
): avatarId is (typeof LOCKED_AVATAR_IDS)[number] {
...
export const AVATAR_UNLOCK_HINTS: Record<
  (typeof LOCKED_AVATAR_IDS)[number],
  string
> = {
