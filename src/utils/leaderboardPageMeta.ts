...
const DEFAULT_LEADERBOARD_META = {
  ...
  description:
    "OSRS combat log leaderboards on Runelogs. Compare run times and boss DPS for Chambers of Xeric, Theatre of Blood, Tombs of Amascut, Inferno, Colosseum, Gauntlet, Mokhaiotl, Yama, and Maggot King.",
