...
export const DEFAULT_TITLE = 'Runelogs - Combat analysis for Old School RuneScape';
...
function applyOpenGraphTags(title: string, description: string, canonicalUrl: string) {
