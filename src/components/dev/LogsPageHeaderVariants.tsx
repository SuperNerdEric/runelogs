...
const Variant01Current: React.FC = () => (
    <HeaderShell>
        ...
        <Typography sx={{ ...accountTextSx, textTransform: 'capitalize', fontWeight: 500, fontSize: '1rem', mt: 0.25 }}>
            {displayName}
        </Typography>
    </HeaderShell>
);
...
const Variant02InlineMiddot: React.FC = () => (
    <HeaderShell>
        <Typography variant="h4" sx={{ m: 0, fontWeight: 600, color: colors.text.primary }}>
            Logs
            <Box component="span" sx={{ color: colors.text.muted, fontWeight: 400, mx: 1 }}>·</Box>
            <Box component="span" sx={{ ...accountTextSx, textTransform: 'capitalize', fontWeight: 600 }}>
                {displayName}
            </Box>
        </Typography>
    </HeaderShell>
...
const Variant03InlineColon: React.FC = () => (
    <HeaderShell>
        <Typography variant="h4" sx={{ m: 0, fontWeight: 600, color: colors.text.primary }}>
            Logs:
            <Box component="span" sx={{ ...accountTextSx, textTransform: 'capitalize', fontWeight: 600, ml: 1 }}>
                {displayName}
            </Box>
        </Typography>
    </HeaderShell>
...
const Variant04InlineNameSmaller: React.FC = () => (
    <HeaderShell>
        <Box sx={{ display: 'flex', alignItems: 'baseline', gap: 1, flexWrap: 'wrap' }}>
            ...
            <Typography sx={{ ...accountTextSx, textTransform: 'capitalize', fontWeight: 600, fontSize: '1.125rem' }}>
                {displayName}
            </Typography>
        </Box>
    </HeaderShell>
...
const Variant05InlineNameSameSize: React.FC = () => (
    <HeaderShell>
        <Box sx={{ display: 'flex', alignItems: 'baseline', gap: 1, flexWrap: 'wrap' }}>
            ...
            <Typography variant="h4" sx={{ m: 0, fontWeight: 600, ...accountTextSx, textTransform: 'capitalize' }}>
                {displayName}
            </Typography>
        </Box>
    </HeaderShell>
...
const Variant06EyebrowLogsNameHero: React.FC = () => (
    <HeaderShell>
        ...
        <Typography variant="h4" sx={{ m: 0, fontWeight: 600, textTransform: 'capitalize', color: colors.text.primary }}>
            {displayName}
        </Typography>
    </HeaderShell>
);
...
const Variant07NameHeroLogsCaption: React.FC = () => (
    <HeaderShell>
        <Typography variant="h4" sx={{ m: 0, fontWeight: 600, textTransform: 'capitalize', ...accountTextSx }}>
            {displayName}
        </Typography>
        <Typography sx={{ color: colors.text.muted, fontSize: '0.875rem', mt: 0.25 }}>
            Uploaded logs
        </Typography>
    </HeaderShell>
);
...
const Variant09NameBelowLarger: React.FC = () => (
    <HeaderShell>
        ...
        <Typography sx={{ ...accountTextSx, textTransform: 'capitalize', fontWeight: 600, fontSize: '1.25rem', mt: 0.25 }}>
            {displayName}
        </Typography>
    </HeaderShell>
);
...
const Variant10NameBelowSmaller: React.FC = () => (
    <HeaderShell>
        ...
        <Typography sx={{ ...accountTextSx, textTransform: 'capitalize', fontWeight: 500, fontSize: '0.8125rem', mt: 0.25 }}>
            {displayName}
        </Typography>
    </HeaderShell>
);
...
const Variant11NameBelowBold: React.FC = () => (
    <HeaderShell>
        ...
        <Typography sx={{ ...accountTextSx, textTransform: 'capitalize', fontWeight: 700, fontSize: '1rem', mt: 0.25 }}>
            {displayName}
        </Typography>
    </HeaderShell>
);
...
const Variant12NameBelowMuted: React.FC = () => (
    <HeaderShell>
        ...
        <Typography sx={{ color: colors.text.muted, textTransform: 'capitalize', fontWeight: 500, fontSize: '1rem', mt: 0.25 }}>
            {displayName}
        </Typography>
    </HeaderShell>
);
...
const Variant13AtUsername: React.FC = () => (
    <HeaderShell>
        ...
        <Typography sx={{ fontSize: '1rem', mt: 0.25 }}>
            <Box component="span" sx={{ color: colors.text.muted }}>@</Box>
            <Box component="span" sx={{ ...accountTextSx, textTransform: 'lowercase', fontWeight: 500 }}>
                {SAMPLE_UPLOADER}
            </Box>
        </Typography>
    </HeaderShell>
...
const Variant14PossessiveTitle: React.FC = () => (
    <HeaderShell>
        <Typography variant="h4" sx={{ m: 0, fontWeight: 600, color: colors.text.primary, textTransform: 'capitalize' }}>
            {displayName}&apos;s Logs
        </Typography>
    </HeaderShell>
);
...
const Variant15NameAboveLogs: React.FC = () => (
    <HeaderShell>
        <Typography sx={{ ...accountTextSx, textTransform: 'capitalize', fontWeight: 600, fontSize: '1.125rem', m: 0 }}>
            {displayName}
        </Typography>
        <Typography variant="h4" sx={{ m: 0, fontWeight: 600, color: colors.text.primary, mt: 0.125 }}>
            Logs
        </Typography>
    </HeaderShell>
);
...
const Variant16NameRightInBlock: React.FC = () => (
    <HeaderShell textSx={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', gap: 2, width: '100%' }}>
        <Typography variant="h4" sx={{ m: 0, fontWeight: 600, color: colors.text.primary }}>
            Logs
        </Typography>
        <Typography sx={{ ...accountTextSx, textTransform: 'capitalize', fontWeight: 600, fontSize: '1.125rem' }}>
...
const Variant20StackedBothH4: React.FC = () => (
    <HeaderShell>
        <Typography variant="h4" sx={{ m: 0, fontWeight: 600, color: colors.text.primary, lineHeight: 1.2 }}>
            Logs
        </Typography>
        <Typography variant="h4" sx={{ m: 0, fontWeight: 600, lineHeight: 1.2, mt: 0.25, ...accountTextSx, textTransform: 'capitalize' }}>
            {displayName}
        </Typography>
    </HeaderShell>
);
...
const LogsPageHeaderVariants: React.FC = () => (
    <Box sx={{ ...contentColumnSx, mt: 2, px: 2, pb: 6, [media.mobileDown]: { px: 1 } }}>
        <Box sx={{ mb: 4 }}>
            <Typography variant="h4" sx={{ m: 0, fontWeight: 600, color: colors.text.primary, mb: 1 }}>
                Logs Page Header Variants
            </Typography>
            <Typography sx={{ color: colors.text.muted, fontSize: '0.95rem', maxWidth: 720 }}>
                ...
                <Box component="span" sx={{ ...accountTextSx, textTransform: 'capitalize' }}>{displayName}</Box>.
