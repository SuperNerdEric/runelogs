  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <ExpandMoreIcon
            sx={{ fontSize: 18, color: expanded ? accent : colors.text.muted }}
          />
        </Box>
      </Box>
...
export default function HomeBlogPreview() {
  ...
  return (
    <Box
      component="section"
      aria-label="Latest blog updates"
      sx={{ mt: 2, mb: 0.5 }}
    >
      <Box
        sx={{
      ...
      >
        ...
        >
          All posts
          <ArrowForwardIcon
            className="home-blog-preview-all-arrow"
            sx={{ fontSize: 14, transition: "transform 0.15s ease" }}
          />
        </Link>
      </Box>
