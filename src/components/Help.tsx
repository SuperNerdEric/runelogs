      ...
      <Box sx={{ px: 0.5 }}>
        ...
        <Box sx={{ mt: 5 }}>
          ...
          <Typography variant="body1" sx={{ ...bodyTextSx, mb: 1.5 }}>
            Runelogs is a community-driven project, and we&apos;re happy to help
            if you run into any issues. Our Discord is usually the quickest way
            to get answers — use #issues and #suggestions for bugs and feature
            ideas. GitHub is also a good place for issues, discussions, and pull
            requests.
          </Typography>
          <Typography
            variant="body1"
            sx={{ color: colors.text.primary, lineHeight: 1.6 }}
          >
            Reach out on{" "}
            <Link
...
const faq: FaqItem[] = [
  {
    ...
    body: (
      <Typography variant="body1">
        Runelogs is a combat log analysis tool for Old School RuneScape that
        works with the{" "}
        <Link
        ...
        plugin to help players review fights, track performance, and improve
        strategy. It offers leaderboards, detailed breakdowns, and
        visualizations powered by parsed in-game data.
      </Typography>
    ),
  },
  {
    ...
    body: (
      <Typography variant="body1">
        ...
        <Box
          ...
          sx={helpIconInlineSx}
        />{" "}
        from in-game show up as an Unknown source by default. However, if
        another player is in your{" "}
        <Link
          href="https://github.com/runelite/runelite/wiki/Party"
          target="_blank"
          rel="noopener noreferrer"
        >
          Party
        </Link>{" "}
        with the Combat Logger plugin running, you will be able to see their
        hitsplats as the plugin shares it automatically.
      </Typography>
    ),
  },
  {
    ...
    body: (
      <Typography variant="body1">
        ...
        <Box
          ...
          sx={helpIconInlineSx}
        />{" "}
        that indicate it is your damage. There is currently no way to
        differentiate your thrall&apos;s damage from your damage.
      </Typography>
    ),
  },
  {
    ...
    body: (
      <Typography variant="body1">
        ...
        <Box
          ...
          sx={helpIconInlineSx}
        />{" "}
        whose source is not able to be detected by the plugin. For example,
        Zebak&apos;s breath that kills his own boulders uses darker tinted
        hitsplats and will show up as an Unknown damage source. This is a
        limitation of the OSRS client.
      </Typography>
    ),
  },
];
