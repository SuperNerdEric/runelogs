...
export default function Home() {
  ...
  return (
    <Box
      sx={{ ...contentColumnSx, px: 2, pb: 0, [media.mobileDown]: { px: 1 } }}
    >
      ...
      <Typography paragraph>
        ...
        {!isAuthenticated ? (
          <>
            To upload a log please <strong>Log In</strong> /{" "}
            <strong>Register</strong> for a free account.
          </>
        ) : (
          <>
      ...
      <Box mt={4}>
        <Box pt={0} pb={1} display="flex" alignItems="center" gap={1}>
          ...
          >
            <HistoryIcon
              sx={{ color: colors.text.rune, fontSize: "2.125rem" }}
            />
          </Box>
          <Typography
            component={RouterLink}
