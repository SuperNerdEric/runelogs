    ...
    >
      ...
      <Box sx={{ px: 0.5 }} component="article">
        <Typography variant="body1" sx={bodyTextSx}>
          Runelogs is a modern combat log viewer for Old School RuneScape, built
          around the{" "}
          <Link
        ...
        <Typography variant="body1" sx={bodyTextSx}>
          ...
          . If your party members also run the plugin, their damage shows up by
          name instead of as &quot;Unknown.&quot;
        </Typography>
        <Typography variant="body1" sx={bodyTextSx}>
        ...
        <Typography variant="body1" sx={bodyTextSx}>
          ...
          . You can rename logs, delete them, and filter by content type and
          party size.
        </Typography>
        ...
        <Typography variant="body1" sx={bodyTextSx}>
          ...
          page and paste it into the plugin settings. Anyone with the log link
          can follow fights as they happen, with pages updating in real time.
        </Typography>
        ...
        <Typography variant="body1" sx={bodyTextSx}>
          Duration boards rank full run times. DPS boards rank individual boss
          fights listed above (plus an Overall aggregate where applicable).
          Mokhaiotl also has a Deep Delve high-score board. Yama has separate
          solo and duo (2-player) boards. Player profiles show personal bests.
        </Typography>
        ...
        <Typography variant="body1" sx={bodyTextSx}>
          ...
          stays current with the latest logs from everyone, filterable by
          content and team size. Search for a player in the header to open their
          profile, logs, and personal bests. Profiles can include a bio, avatar,
          and contact links.
        </Typography>
        ...
        <Typography variant="body1" sx={bodyTextSx}>
          Combat Logger records game events on each tick (0.6 seconds). That
          includes:
        </Typography>
        <Box component="ul" sx={listSx}>
        ...
        <Typography variant="body1" sx={bodyTextSx}>
          We map item and NPC IDs to names using data from the OSRS Wiki and
        ...
        <Typography variant="body1" sx={bodyTextSx}>
          Yes. Runelogs only reads logs from the Combat Logger plugin on
          RuneLite. OSRS mobile and the official client are not supported.
        </Typography>
        <Typography component="h3" sx={subsectionTitleSx}>
          Is Runelogs free?
        </Typography>
        ...
        <Typography variant="body1" sx={bodyTextSx}>
          OSRS does not always expose who dealt darker hitsplats. If a party
          member runs Combat Logger, their damage is usually attributed
          correctly. See the{" "}
          <Link component={RouterLink} to="/help" sx={linkSx}>
            Help page
          </Link>{" "}
        ...
        <Typography variant="body1" sx={bodyTextSx}>
          The log records whichever account is logged in on that RuneLite
          client. Upload it from the Runelogs account you want the log tied to.
        </Typography>
        <Typography component="h3" sx={subsectionTitleSx}>
