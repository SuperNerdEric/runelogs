...
export function getHiscoreSpriteUrl(
...
export function resolveLeaderboardSpriteKey(
  ...
  return (
    getLeaderboardContentSpriteKey(leaderboardName) ??
    resolveBossNameSpriteKey(leaderboardName) ??
    getLeaderboardContentSpriteKey(
      inferStandaloneLeaderboardContent(leaderboardName) ?? "",
    )
  );
}
...
export function resolveFightGroupSpriteKey(
  ...
  return (
    resolveLeaderboardSpriteKey(inferStandaloneLeaderboardContent(baseName)) ??
...
export function resolveFightSpriteKey(
  ...
  return (
    resolveBossNameSpriteKey(fightKey) ?? resolveContentSpriteKey(contentValue)
  );
}
...
export function resolveEncounterRowSpriteKey(
  ...
  return (
    resolveBossNameSpriteKey(mainEnemyName) ??
