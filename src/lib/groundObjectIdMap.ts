...
export const groundObjectIdMap: Record<number, GroundObject> = {
    ...
    33033: { name: "Sotetseg maze disabled tile", imageUrl: sotetsegMazeDisabled },
    33034: { name: "Sotetseg maze inactive tile", imageUrl: sotetsegMazeInactive },
    33035: { name: "Sotetseg maze active tile", imageUrl: sotetsegMazeActive },
    50744: { name: "Colosseum reentry pool (secondary)", imageUrl: coloReentryPoolSecondary },
};
