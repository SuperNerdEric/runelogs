...
def main():
    ...
    for k, v in wiki_data.items():
        ...
        combat_style = getPrintoutValue(po['Combat style']) or ''
        weapon_speed = int(getPrintoutValue(po['Weapon attack speed']) or 0)

        # Subtract weapon speed for ranged weapon assuming using rapid style
